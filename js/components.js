...
(function() {
  ...
  <div class="chatbot-widget minimized" id="chatbot-widget">
    ...
    <div class="chatbot-window window outset-border">
      ...
      <div class="window-body chatbot-body" style="padding:10px;display:flex;flex-direction:column;height:270px;flex:0 0 auto;overflow:hidden;box-sizing:border-box;">
        <div class="chatbot-messages" id="chatbot-messages" style="flex:1;min-height:0;overflow-y:auto;display:flex;flex-direction:column;gap:6px;padding-right:4px;margin-bottom:8px;">
